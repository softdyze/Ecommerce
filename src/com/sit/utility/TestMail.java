...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "jamki89hosting@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Das Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Das Electronics.<br>"
					...
					+ "<span class='greenText'>DASBABU300</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
