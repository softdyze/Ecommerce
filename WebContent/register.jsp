		...
		<div class="row"
			...
			<form action="./RegisterSrv" method="post"
				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						<label for="last_name">Pin Code</label> <input type="text"
							patteren="\d*" name="pincode" maxlength="6" class="form-control"
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Password</label> <input type="text"
